...
class Installer extends Component {
    ...
    public function save() {
        ...
        if ($this->current === 0) {
            ...
            // Run database seeders and create storage link
            Artisan::call('db:seed', ['--force' => true]);
            Artisan::call('storage:link');
            $this->success = 'Configuration saved. Please continue with creating your Admin Account';
            $this->current = 2;
        } else {
            $this->validate(
                [
            ...
            if ($this->createAdminAccount()) {
                file_put_contents(storage_path('installed'), 'tSMS - successfully installed on ' . date('Y/m/d h:i:sa'));
