<x-jet-form-section submit="update">
    ...
    <x-slot name="description">
        ...
        <a class="font-bold underline" href="https://fontawesome.com/v5/search?m=free" target="_blank" rel="noopener noreferrer">{{ __('this link.') }}</a>
        <br><br>
        ...
        <div x-data="{ icon: '{{ $social['icon'] }}' }" class="col-span-6 flex">
            ...
            <div class="flex-1 ml-3">
                ...
                <div class="flex">
                    ...
                    <button type="button" wire:click="remove({{ $key }})" class="form-input rounded-md ml-3 mt-1 px-3 bg-red-700 text-white border-0"><i class="fas fa-trash"></i></button>  
                </div>
