                ...
                <div class="mt-5 -mb-5 hidden annoucements" data-id="1">
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <div class="col-span-6">
                            <div class="w-full py-3 px-4 overflow-hidden sm:rounded-md flex items-center border bg-blue-50 border-primary">
                                <div class="text-primary w-10"> 
                                ...
                                <div class="ml-4 flex-1">
                                    ...
                                    <div class="text-md">
                                        {{ __('tSMS now comes with SaaS. Setup the plans and map numbers to get started.') }} <a class="font-medium underline" href="https://support.thehp.in/article/18059" target="_blank">{{ __('View Tutorial') }}</a>
                                    </div>
                                </div>
                                <div class="close text-primary w-5 cursor-pointer"> 
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
